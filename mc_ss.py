...
KW_LABELS = {
    ...
    'aim assist':'AimAssist', 'aimassist module':'AimAssist',
    'anti-aim':'AntiAim', 'antiaim':'AntiAim', 'anti aim':'AntiAim',
    'critspam':'CritSpam', 'crit spam':'CritSpam', 'crit module':'CritMode',
    ...
    'no clip':'NoClip', 'noclip module':'NoClip',
    'anti knockback':'AntiKnockback', 'antiknockback':'AntiKnockback', 'antikb':'AntiKnockback',
    'fly hack':'FlyHack', 'flyhack':'FlyHack', 'fly module':'FlyHack',
    'speed hack':'SpeedHack', 'speedhack':'SpeedHack', 'speed module':'SpeedHack',
    'scaffold module':'Scaffold', 'scaffoldmod':'Scaffold', 'scaffold walk':'Scaffold',
    'phase module':'Phase', 'phasemod':'Phase',
    # Visual / ESP — exact
    'wall hack':'WallHack', 'wallhack':'WallHack',
    'xray hack':'XRay', 'xrayhack':'XRay', 'x-ray hack':'XRay',
    'player esp':'PlayerESP', 'playeresp':'PlayerESP',
    'entity esp':'EntityESP', 'entityesp':'EntityESP',
    'hitbox esp':'HitboxESP', 'hitboxesp':'HitboxESP',
    'chams module':'Chams', 'chamsmod':'Chams',
    # AutoFarm — exact
    'chest stealer':'ChestStealer', 'cheststealer':'ChestStealer',
    'auto farm':'AutoFarm', 'autofarm':'AutoFarm',
    'auto fish':'AutoFish', 'autofish':'AutoFish',
    'auto steal':'AutoSteal', 'autosteal':'AutoSteal',
    'nuker module':'Nuker', 'nukermod':'Nuker',
    # Network — exact
    'packet fly':'PacketFly', 'packetfly':'PacketFly',
    'ping spoof':'PingSpoof', 'pingspoof':'PingSpoof',
